...
public class MainActivity extends AppCompatActivity {
    ...
    public void param() {
        ...
        final Data myData = new Data.Builder()
                ...
                .putInt(WorkerParameters1.KEY_X_ARG, 42)
                // ... and build the actual Data object:
                .build();

        // ...then create and enqueue a OneTimeWorkRequest that uses those arguments
        OneTimeWorkRequest mathWork = new OneTimeWorkRequest.Builder(WorkerParameters1.class)
                .setInputData(myData)
                .build();
                ...
                .observe(this, new Observer<WorkInfo>() {
                    ...
                    public void onChanged(@Nullable WorkInfo status) {
                        if (status != null && status.getState().isFinished()) {
                            int myResult = status.getOutputData().getInt(WorkerParameters1.KEY_RESULT,
                                    -1);
